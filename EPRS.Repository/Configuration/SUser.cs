...
namespace EPRS.Repository
{
	...
	public class SUserConfiguration:EntityTypeConfiguration<SUser>
    {
		public SUserConfiguration()
        {
			...
			Property(e =>e.LoginTime).HasColumnName("LoginTime").HasDatabaseGeneratedOption(DatabaseGeneratedOption.Computed).HasColumnType("DateTime").IsRequired();
			...
			Property(e =>e.CreateTime).HasColumnName("CreateTime").HasDatabaseGeneratedOption(DatabaseGeneratedOption.Computed).HasColumnType("DateTime").IsRequired();
			Property(e =>e.UpdateTime).HasColumnName("UpdateTime").HasDatabaseGeneratedOption(DatabaseGeneratedOption.Computed).HasColumnType("DateTime").IsRequired();
